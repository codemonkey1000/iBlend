...
uses
  ...
  Datasnap.DBClient, Data.DB, Data.Bind.Components, Data.Bind.DBScope;
type
...
(* *)
    ...
    FromClientDataSet2: TClientDataSet;
...
{$ELSE}
    Result:= TPath.GetSharedDocumentsPath+PathDelim+'LionSoftware'+
      PathDelim+AppName+PathDelim+'Community'+PathDelim;
//      PathDelim+AppName+PathDelim+'Company'+PathDelim;
{$ENDIF}
  end;
...
//end;
//
//procedure TCDSDataModule.CreateTableFrom;
...
begin
  ...
  Logon                .FileName:= UsrPath+'Logon'+Ext;
  ...
  if not FileExists(LogOn                .FileName) then CreateTableLogOn;
